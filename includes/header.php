...
<title><?php echo $page_title; ?></title>
    ...
    #hide-for-print-digital{ display: none; }
    @media print
    {
    	#non-printable { display: none; }
    	#printable { display: block;
						margin-left:0px; }
		#hide-for-print-digital{ display: block; }
    }
    </style>
...
<div class="main-content" <?php if(!isset($_SESSION['user_id']) || isset($page)): echo 'style="width:100%;"'; endif; ?>>
   ...
   <div class="page-title">
        <h1 class="title" id="non-printable"><?php echo $page_title; ?></h1>
         <h1 class="title pull-center" id="hide-for-print-digital">HERITAGE DIGI LINK INT'L LTD INVOICE</h1>
