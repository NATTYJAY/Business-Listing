...
<?php if(!isset($page)): ?>
<footer class="main-footer sticky footer-type-1" id="non-printable">
    <div class="footer-inner">
        <!-- Add your copyright text here -->
       	<div class="footer-text">
            &copy; Copyright <?php echo date('Y'); ?> 
            <strong><?php echo get_option('site_name'); ?></strong>
        </div>
...
function getProduct(product_id) {
	$.ajax({
	 ...
	 success: function(response) {
	   ...
	   var content_5 = "<td><input type='text' readonly='readonly' class='selling_price' name='selling_price[]' value='"+product_price+"'></td><td><input type='text' class='itemtotal' readonly='readonly' value='"+grand_total+"' /><input type='hidden' name='warehouse_id[]' value='"+warehouse_id+"' /></td></tr>"; 
