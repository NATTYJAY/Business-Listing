<?php
	...
	if($payment_method == 'cash') { 
		$receiving_id = $client->add_receiving($date, 'Cash Sale', $sale_id, $memo, $grand_total, $client_id);
		$client_log_id = $client->add_log($date, $client_id, 'Sale Receiving', $receiving_id);
	}
	if($payment_method == 'credit_card') { 
		$receiving_id = $client->add_receiving($date, 'Credit Card Sale', $sale_id, $memo, $grand_total, $client_id);
		$client_log_id = $client->add_log($date, $client_id, 'Sale Receiving', $receiving_id);
	}
