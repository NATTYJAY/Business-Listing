...
<?php if(partial_access('admin') || $st_access->have_module_access('sales')): ?>
	<li>
        <a data-toggle="dropdown" class="dropdown-toggle" href="#">Stock<b class="caret"></b></a>
        <ul>
            <li><a href="manage_sale.php">Add new</a></li>
            <li><a href="sale.php">Stock Details</a></li>
        </ul>
    </li>
<?php endif; ?>
...
<?php endif; ?>
<?php if(partial_access('admin') || $st_access->have_module_access('reception')): ?>
	<li>
        <a data-toggle="dropdown" class="dropdown-toggle" href="visitors.php">Visitor(s)<b class="caret"></b></a>
        <ul>
            <li><a href="visitors.php">Visitors</a></li>
            <li><a href="manage_visitor.php">Add New</a></li>
        </ul>
    </li>
<?php endif; ?>
