...
<div class="right_col" role="main"><br/><br/><br/>
                 ...
                 <?php
                  if($_SERVER['REQUEST_METHOD']== "POST"){
                    ...
                    $cat_desc   = clean($_POST['catdesc']);
                      ...
                      if($result){
                        redirect("addcat.php?thisisokay=yesokay");
                      }

                      else{
                        redirect("addcat.php?extension=notgood");
                      }
  ...
  <b style="color:green;">Category Added succesfully ?? <br/><a href="http://localhost/magnetblog/admin/addcat.php"> Click Here to add another</a> </b>
</div>
<?php endif; ?>
  ...
  <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
  <span class="sr-only">Error:</span>
  <b style="color:red;">Category cannot be added to the database??</b>
</div>
<?php endif; ?>
                              ...
                              <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name ="catname" class="form-control" id="catname" placeholder="Category Name" required>
                                        </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name ="catdesc" class="form-control" id="catdesc" placeholder="Course Code" required>
                                </div>
                               ...
                               <div class="col-md-12 col-sm-12 col-xs-12">
                                <label for="pass">c_id</label>
                                  <div class="input-group">
                                   ...
                                   <input type="text" name = "c_id" class="form-control" id="c_id" type="text">
                                </div>
                               </div>
                              </div> 
                             <div class="col-md-12 col-sm-12 col-xs-12"><br/>
                              <input type="submit" id="subsitu" value="Add Category" class="btn btn-danger" />
                              <br> </br>
                            </div>
  </form>
            </div>
       ...
       <input type="button" name="dele" value="Yes" id="yes" class="btn btn-danger btn-sm" />
        ...
        <footer>
          <div class="pull-right">
            Exam office Admin Dashboard DESIGNED BY<a href="https://colorlib.com">TEAM 2</a>
          </div>
