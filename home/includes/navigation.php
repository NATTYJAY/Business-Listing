		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">Task & Time</a>
				...
				<ul class="nav navbar-nav navbar-right">
					<?php if (($isAdmin == '1') || ($isMgr == '1')) { ?>
                        ...
                        <li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $payRollNav; ?></a>
							<ul class="dropdown-menu">
								<li><a href="index.php?page=DayToDay"><?php echo $dayToDay; ?></a></li>
								<li><a href="index.php?page=inactiveEmployees"><?php echo $inactiveEmpNav; ?></a></li>
								<?php if ($isAdmin == '1') { ?>
									<li><a href="index.php?page=newEmployee"><?php echo $newEmpNav; ?></a></li>
								<?php } ?>
